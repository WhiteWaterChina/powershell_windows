...
$start_time=Get-Date
$status_bbu_temp=(.\storcli64.exe /c0/cv show all|Out-String) -match "Status = (.*)"
$status_bbu=$Matches[1]
while (0 -ne 1)
{
...
set border 3 lt 3 lw 2
set key box
plot '${log_dir}\chip_temp'  title 'Chip Temp' w lp pt 7 
set output
"@
}
